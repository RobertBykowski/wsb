...
class TestCart:
    ...
    def clean_cart(self):
        yield
        HeaderMenu(self.driver, self.wait).clean_cart()
    ...
    def test_one_item_in_cart(self, clean_cart):
    ...
    def test_two_items_in_cart(self, clean_cart):
    ...
    def test_quantity_update_in_cart(self, clean_cart):
